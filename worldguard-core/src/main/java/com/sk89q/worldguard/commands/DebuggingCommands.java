...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testbreak"}, usage = "[player]", desc = "i18n:cmd.testbreak", min = 1, max = 1, flags = "ts")
    ...
    @Command(aliases = {"testplace"}, usage = "[player]", desc = "i18n:cmd.testplace", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[player]", desc = "i18n:cmd.testinteract", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[player]", desc = "i18n:cmd.testdamage", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
