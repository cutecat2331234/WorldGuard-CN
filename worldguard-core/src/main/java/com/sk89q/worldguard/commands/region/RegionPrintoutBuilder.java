...
public class RegionPrintoutBuilder implements Callable<TextComponent> {
    ...
    public void appendBasics() {
        builder.append(TextComponent.of(I18n.tr("ui.region.label"), TextColor.BLUE));
        ...
        builder.append(TextComponent.of(I18n.tr("ui.region.type_prefix"), TextColor.GRAY));
        builder.append(TextComponent.of(region.getType().getName()));
        
        builder.append(TextComponent.of(I18n.tr("ui.region.priority_prefix"), TextColor.GRAY));
        appendPriorityComponent(region);
        builder.append(TextComponent.of(I18n.tr("ui.region.paren_close"), TextColor.GRAY));
    ...
    public void appendFlags() {
        builder.append(TextComponent.of(I18n.tr("ui.region.flags"), TextColor.BLUE));
    ...
    public void appendFlagsList(boolean useColors) {
        ...
        for (Flag<?> flag : WorldGuard.getInstance().getFlagRegistry()) {
            ...
            if (perms != null && perms.maySetFlag(region, flag)) {
                flagText = flagText.hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_set_flag"))))
        ...
        if (!hasFlags) {
            TextComponent noFlags = TextComponent.of(I18n.tr("ui.common.none"), useColors ? TextColor.RED : TextColor.WHITE);
            builder.append(noFlags);
        }

        if (perms != null && perms.maySetFlag(region)) {
            builder.append(TextComponent.space())
                    .append(TextComponent.of(I18n.tr("ui.region.flags_button"), useColors ? TextColor.GREEN : TextColor.GRAY)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_set_a_flag"))))
        ...
        while (it.hasPrevious()) {
            ...
            if (perms != null && perms.mayLookup(cur)) {
                builder.append(TextComponent.of(cur.getId(), useColors ? TextColor.GREEN : TextColor.WHITE)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_for_info"))))
            ...
            if (!cur.equals(region)) {
                builder.append(TextComponent.of(I18n.tr("ui.region.parent_prefix"), useColors ? TextColor.GRAY : TextColor.WHITE));
                appendPriorityComponent(cur);
                builder.append(TextComponent.of(I18n.tr("ui.region.paren_close"), useColors ? TextColor.GRAY : TextColor.WHITE));
            }
            if (last != null && cur.equals(region) && perms != null && perms.maySetParent(cur, last)) {
                builder.append(TextComponent.space());
                builder.append(TextComponent.of("[X]", TextColor.RED)
                        .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_unlink_parent"))))
    ...
    public void appendDomain() {
        builder.append(TextComponent.of(I18n.tr("ui.region.owners"), TextColor.BLUE));
        ...
        builder.append(TextComponent.of(I18n.tr("ui.region.members"), TextColor.BLUE));
    ...
    private void addDomainString(DefaultDomain domain, String addCommand, String removeCommand) {
        if (domain.size() == 0) {
            builder.append(ErrorFormat.wrap(I18n.tr("ui.common.none")));
        } else {
            if (perms != null) {
        ...
        if (addCommand != null) {
            builder.append(TextComponent.space().append(TextComponent.of(I18n.tr("ui.region.add"), TextColor.GREEN)
                            .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_add"))))
                            .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND,
                                    "/rg " + addCommand + " -w \"" + world + "\" " + region.getId() + " "))));
        }
        if (removeCommand != null && domain.size() > 0) {
            builder.append(TextComponent.space().append(TextComponent.of(I18n.tr("ui.region.remove"), TextColor.RED)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_remove"))))
                    .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND,
                            "/rg " + removeCommand + " -w \"" + world + "\" " + region.getId() + " "))));
            builder.append(TextComponent.space().append(TextComponent.of(I18n.tr("ui.region.clear"), TextColor.RED)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_clear"))))
                    .clickEvent(ClickEvent.of(ClickEvent.Action.SUGGEST_COMMAND,
    ...
    public void appendBounds() {
        ...
        builder.append(TextComponent.of(I18n.tr("ui.region.bounds"), TextColor.BLUE));
        TextComponent bound = TextComponent.of(" " + min + " -> " + max, TextColor.YELLOW);
        if (perms != null && perms.maySelect(region)) {
            bound = bound
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_select"))))
        ...
        if (teleFlag != null && perms != null && perms.mayTeleportTo(region)) {
            builder.append(TextComponent.space().append(TextComponent.of(I18n.tr("ui.region.teleport"), TextColor.GRAY)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT,
                            TextComponent.of(I18n.tr("ui.region.click_teleport")).append(TextComponent.newline()).append(
            ...
            builder.append(TextComponent.space().append(TextComponent.of(I18n.tr("ui.region.center_teleport"), TextColor.GRAY)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT,
                            TextComponent.of(I18n.tr("ui.region.click_center_teleport"))))
                    .clickEvent(ClickEvent.of(ClickEvent.Action.RUN_COMMAND,
    ...
    private void appendPriorityComponent(ProtectedRegion rg) {
        ...
        if (perms != null && perms.maySetPriority(rg)) {
            builder.append(TextComponent.of(content, TextColor.GOLD)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of(I18n.tr("ui.region.click_change_priority"))))
    ...
    private void appendRegionInformation() {
        ...
        if (cache != null && perms == null) {
            builder.append(SubtleFormat.wrap(I18n.tr("ui.region.last_seen_names")));
        }
    }

    @Override
    public TextComponent call() {
        MessageBox box = new MessageBox(I18n.tr("ui.region.info_title"), builder);
