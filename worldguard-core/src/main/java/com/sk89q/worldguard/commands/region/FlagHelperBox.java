...
class FlagHelperBox extends PaginationBox {
    ...
    FlagHelperBox(World world, ProtectedRegion region, RegionPermissionModel perms) {
        super(I18n.tr("ui.flags.title", "id", region.getId()), "/rg flags -w \"" + world.getName() + "\" -p %page% " + region.getId());
        this.world = world;
        this.region = region;
        this.perms = perms;
    }
    ...
    public Component getComponent(int number) {
        if (number == Flags.INBUILT_FLAGS.size()) {
            return centerAndBorder(TextComponent.of(I18n.tr("ui.flags.third_party"), TextColor.AQUA));
        ...
        if (flag.usesMembershipAsDefault()) {
            builder.append(TextComponent.empty().append(TextComponent.of("*", TextColor.AQUA))
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT,
                            TextComponent.of(I18n.tr("ui.flags.membership_default_hint")))));
            length += monoSpace ? 1 : FlagFontInfo.getPxLength('*');
        }
        if (flag == Flags.PASSTHROUGH) {
            builder.append(TextComponent.empty().append(TextComponent.of("*", TextColor.AQUA))
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT,
                            TextComponent.of(I18n.tr("ui.flags.passthrough_hint")))));
            length += monoSpace ? 1 : FlagFontInfo.getPxLength('*');
        }
    ...
    private <V> void appendValueChoices(TextComponent.Builder builder, Flag<V> flag, Iterator<V> choices, @Nullable String suggestChoice) {
        ...
        while (choices.hasNext()) {
            ...
            if (maySet) {
                if (isExplicitSet) {
                    hoverTexts.add(TextComponent.of(I18n.tr("ui.flags.click_unset"), TextColor.GOLD));
                } else if (DANGER_ZONE.contains(flag) && !(ProtectedRegion.GLOBAL_REGION.equals(region.getId()) && flag == Flags.PASSTHROUGH)) {
                    hoverTexts.add(TextComponent.of(I18n.tr("ui.flags.danger_line1"), TextColor.RED)
                            .append(TextComponent.newline())
                            .append(TextComponent.of(I18n.tr("ui.flags.danger_line2")))
                            .append(TextComponent.newline())
                            .append(TextComponent.of(I18n.tr("ui.flags.danger_hint"))));
                } else {
                    hoverTexts.add(TextComponent.of(I18n.tr("ui.flags.click_set"), TextColor.GOLD));
                }
            }
        ...
        if (suggestChoice != null && perms.maySetFlag(region, flag)) {
            builder.append(TextComponent.of(suggestChoice, TextColor.DARK_GRAY)
                    .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT,
                            TextComponent.of(I18n.tr("ui.flags.click_custom"), TextColor.GOLD)))
    ...
    private <V> void appendValueText(TextComponent.Builder builder, Flag<V> flag, String display, @Nullable Component hover) {
        ...
        if (maySet) {
            if (isExplicitSet) {
                hoverTexts.add(TextComponent.of(I18n.tr("ui.flags.click_change"), TextColor.GOLD));
            } else {
                hoverTexts.add(TextComponent.of(I18n.tr("ui.flags.click_set"), TextColor.GOLD));
            }
        }
    ...
    private <V> Component getToolTipHint(V defVal, V currVal, boolean inherited) {
        ...
        if (inherited) {
            if (currVal == defVal) {
                valType = TextComponent.of(I18n.tr("ui.flags.inherited_default_prefix"))
                        .append(TextComponent.of(I18n.tr("ui.flags.inherited_default_word"))
                                .decoration(TextDecoration.UNDERLINED, true))
                        .append(TextComponent.of(I18n.tr("ui.flags.inherited_default_suffix")));
            } else {
                valType = TextComponent.of(I18n.tr("ui.flags.inherited"));
            }
        } else {
            if (currVal == defVal) {
                valType = TextComponent.empty()
                        .append(TextComponent.of(I18n.tr("ui.flags.default_word"))
                                .decoration(TextDecoration.UNDERLINED, true))
                        .append(TextComponent.of(I18n.tr("ui.flags.default_suffix")));
            } else {
                valType = null;
            }
        }
    ...
    private <V> void appendSetFlagValue(TextComponent.Builder builder, SetFlag<V> flag) {
        ...
        if (currVal != null) {
            hoverComp = hoverComp.append(TextComponent.of(I18n.tr("ui.flags.current_values")))
    ...
    private void appendLocationFlagValue(TextComponent.Builder builder, LocationFlag flag) {
        ...
        if (currVal == null) {
            ...
            if (defVal == null) {
                appendValueText(builder, flag, I18n.tr("ui.flags.unset_location"), null);
            } else {
                appendValueText(builder, flag, defVal.toString(), TextComponent.of(I18n.tr("ui.flags.default_value_label"))
                        .append(TextComponent.newline()).append(TextComponent.of(defVal.toString())));
            }
        } else {
            appendValueText(builder, flag, currVal.toString(), TextComponent.of(I18n.tr("ui.flags.current_value_label"))
    ...
    private <V extends Number> void appendNumericFlagValue(TextComponent.Builder builder, NumberFlag<V> flag) {
        ...
        appendValueChoices(builder, flag, (Iterator<V>) choices.iterator(), choices.isEmpty() ? I18n.tr("ui.flags.unset_number") : I18n.tr("ui.flags.custom"));
    }
    ...
    private void appendStringFlagValue(TextComponent.Builder builder, StringFlag flag) {
        ...
        if (currVal == null) {
            ...
            if (defVal == null) {
                appendValueText(builder, flag, I18n.tr("ui.flags.unset_string"), null);
            } else {
                ...
                appendValueText(builder, flag, display, TextComponent.of(I18n.tr("ui.flags.default_value_label"))
            ...
            appendValueText(builder, flag, display, TextComponent.of(I18n.tr("ui.flags.current_value_label"))
